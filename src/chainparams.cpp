...
{
    const char* pszTimestamp = "Jul 28, 2018 7Coin";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x00000109efbc75632452769e918298a645df84bf85eefce1791c1345fa41f74c");
        ...
        consensus.defaultAssumeValid = uint256S("0x00000109efbc75632452769e918298a645df84bf85eefce1791c1345fa41f74c"); //0
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("00000109efbc75632452769e918298a645df84bf85eefce1791c1345fa41f74c"))
            //( 5000, uint256S("000088da7454a860d24788afcb4b8715fb63e2b614b2d85b8e6172d7eb266d7c"))
            //( 5040, uint256S("436940f2461e6327460d1c3e51b30618ccede1006fe51376fcca62245e5ffebf"))
            //( 5080, uint256S("228a5ed697c9e7e1ce1589672cbd9ed6a8866252dbf438b8d40ee7530309b582"))
            //( 5100, uint256S("2934c73d3a6f098faa3099c8228f4591b7c9d1705e5cc87fc85c5a15b2fe9414"))
        };
...
public:
    CTestNetParams() {
        ...
        consensus.nSubsidyHalvingInterval = 985500;
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("00000109efbc75632452769e918298a645df84bf85eefce1791c1345fa41f74c");
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("00000109efbc75632452769e918298a645df84bf85eefce1791c1345fa41f74c");
        ...
        genesis = CreateGenesisBlock(1530115200, 5007081, 0x1f00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("00000109efbc75632452769e918298a645df84bf85eefce1791c1345fa41f74c"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("7Coin4.dynu.net", "7Coin4.dynu.net", false));
...
public:
    CRegTestParams() {
        ...
        consensus.BIP34Height = 0; // BIP34 has not activated on regtest (far in the future so block v1 are not rejected in tests) // activate for 7Coin
        consensus.BIP34Hash = uint256S("00000109efbc75632452769e918298a645df84bf85eefce1791c1345fa41f74c");
