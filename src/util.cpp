...
const char * const BITCOIN_CONF_FILENAME = "7Coin.conf";
const char * const BITCOIN_PID_FILENAME = "7Coind.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\7Coin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\7Coin
    // Mac: ~/Library/Application Support/7Coin
    // Unix: ~/.7Coin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "7Coin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/7Coin";
#else
    // Unix
    return pathRet / ".7Coin";
#endif
#endif
}
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("7Coin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The 7Coin Core developers";
    }
