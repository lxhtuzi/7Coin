...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("7C");
    case mBTC: return QString("m7C");
    case uBTC: return QString::fromUtf8("μ7C");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("7Cs");
    case mBTC: return QString("Milli-7Cs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-7Cs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
