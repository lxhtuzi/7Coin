    ...
    platformStyle(_platformStyle)
{
    ...
    if(fCheckForUpdates && qtumVersionChecker->newVersionAvailable())
    {
        ...
        QString message(tr("New version of 7Coin wallet is available on the 7Coin source code repository: <br /> %1. <br />It is recommended to download it and update this application").arg(link));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a 7Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and 7Coin: URIs)"));
    ...
    QRCTokenAction = new QAction(platformStyle->MultiStatesIcon(":/icons/qrctoken"), tr("&7Coin Tokens"), this);
    QRCTokenAction->setStatusTip(tr("7Coin Tokens (send, receive or add Tokens in list)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your 7Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->MenuColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified 7Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a 7Coin: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->MenuColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible 7Coin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to 7Coin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("7Coin"); // default title
