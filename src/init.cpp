...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/7Coinproject/7Coin>";
    const std::string URL_WEBSITE = "<https://7Coin.org>";
    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                boost::filesystem::path qtumStateDir = GetDataDir() / "state7Coin";
