...
#if defined(NDEBUG)
# error "7Coin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "7Coin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool rawTx)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s 7Coin additional fees, %d delta bytes\n",
...
//////////////////////////////////////////////////////////////////
    ...
    if(pindex->nHeight > 5000 && !Params().GetConsensus().fPoSNoRetargeting) {
        ...
        if(pindex->nMoneySupply > (uint64_t)(2100000000ull + ((pindex->nHeight - 5000) * 1ull)) * COIN){
    ...
    try {
        ...
        while (!blkdat.eof()) {
            ...
            try {
                ...
                // But for 7Coin PoS we need to sync this after every block to ensure txdb is populated for
