...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s 7Coin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  7Coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded 7Coin transaction") + "\n" +
              "  7Coin-tx [options] -create [commands]   " + _("Create hex-encoded 7Coin transaction") + "\n" +
              "\n";
